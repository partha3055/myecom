...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front_assets/css/jquery.smartmenus.bootstrap.css') }}">
    ...
    <link rel="stylesheet" id="switcher" href="{{ asset('front_assets/css/theme-color/default-theme.css') }}">
    <link rel="stylesheet" href="{{ asset('front_assets/css/sequence-theme.modern-slide-in.css') }}" media="all">
                                    ...
                                    <ul>
                                        <li>
                                            <a class="aa-cartbox-img" href="#"><img
                                                    src="{{ asset('front_assets/img/woman-small-2.jpg') }}"
                                                    alt="img"></a>
                                        ...
                                        <li>
                                            <a class="aa-cartbox-img" href="#"><img
                                                    src="{{ asset('front_assets/img/woman-small-1.jpg') }}"
                                                    alt="img"></a>
                                            <div class="aa-cartbox-info">
                                                <h4><a href="#">Product Name</a></h4>
                                                <p>1 x $250</p>
            ...
            <div id="sequence" class="seq">
                <div class="seq-screen">
                    <ul class="seq-canvas">
                        ...
                        <li>
                            <div class="seq-model">
                                <img data-seq src="{{ asset('front_assets/img/slider/1.jpg') }}"
                                    alt="Men slide img" />
                            </div>
                            <div class="seq-title">
                        ...
                        <li>
                            <div class="seq-model">
                                <img data-seq src="{{ asset('front_assets/img/slider/4.jpg') }}"
                                    alt="Shoes slide img" />
                            </div>
                            <div class="seq-title">
                                <span data-seq>Save Up to 75% Off</span>
                        ...
                        <li>
                            <div class="seq-model">
                                <img data-seq src="{{ asset('front_assets/img/slider/5.jpg') }}"
                            ...
                            <div class="col-md-7 no-padding">
                                <div class="aa-promo-right">
                                    <div class="aa-single-promo-right">
                                        <div class="aa-promo-banner">
                                            <img src="{{ asset('front_assets/img/promo-banner-3.jpg') }}"
                                                alt="img">
                                            <div class="aa-prom-content">
                                    ...
                                    <div class="aa-single-promo-right">
                                        <div class="aa-promo-banner">
                                            <img src="{{ asset('front_assets/img/promo-banner-2.jpg') }}"
                                                alt="img">
                                            <div class="aa-prom-content">
                                                <span>Sale Off</span>
                                    ...
                                    <div class="aa-single-promo-right">
                                        <div class="aa-promo-banner">
                                            <img src="{{ asset('front_assets/img/promo-banner-4.jpg') }}"
                                                alt="img">
                                            <div class="aa-prom-content">
                                    ...
                                    <div class="aa-single-promo-right">
                                        <div class="aa-promo-banner">
                                            <img src="{{ asset('front_assets/img/promo-banner-5.jpg') }}"
                                                alt="img">
                                            <div class="aa-prom-content">
                                                <span>25% Off</span>
                                    ...
                                    <div class="tab-pane fade in active" id="men">
                                        <ul class="aa-product-catg">
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/man/polo-shirt-4.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/man/polo-shirt-5.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/man/polo-shirt-6.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                    ...
                                    <div class="tab-pane fade" id="women">
                                        <ul class="aa-product-catg">
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/women/girl-2.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/women/girl-3.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/women/girl-4.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/women/girl-5.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/women/girl-6.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/women/girl-7.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                    ...
                                    <div class="tab-pane fade" id="sports">
                                        <ul class="aa-product-catg">
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-1.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-2.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-3.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-4.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-5.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-6.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-7.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/sports/sport-8.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                    ...
                                    <div class="tab-pane fade" id="electronics">
                                        <ul class="aa-product-catg">
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-1.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-2.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-3.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-4.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-5.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-6.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-7.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img
                                                            src="{{ asset('front_assets/img/electronics/electronic-8.png') }}"
                                                            alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="#"><span
                                                            class="fa fa-shopping-cart"></span>Add To Cart</a>
                                                    <figcaption>
                                                            ...
                                                            <div class="simpleLens-gallery-container"
                                                                ...
                                                                <div class="simpleLens-container">
                                                                    <div class="simpleLens-big-image-container">
                                                                        <a class="simpleLens-lens-image"
                                                                            ...
                                                                            <img src="{{ asset('front_assets/img/view-slider/medium/polo-shirt-1.png') }}"
                                                                ...
                                                                <div class="simpleLens-thumbnails-container">
                                                                    <a href="#"
                                                                        ...
                                                                        <img
                                                                            src="{{ asset('front_assets/img/view-slider/thumbnail/polo-shirt-1.png') }}" />
                                                                    </a>
                                                                    <a href="#"
                                                                        class="simpleLens-thumbnail-wrapper"
                                                                        ...
                                                                        <img
                                                                            src="{{ asset('front_assets/img/view-slider/thumbnail/polo-shirt-3.png') }}">
                                                                    </a>
                                                                    ...
                                                                    <a href="#"
                                                                        ...
                                                                        <img
                                                                            src="{{ asset('front_assets/img/view-slider/thumbnail/polo-shirt-4.png') }}">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="aa-testimonial-area">
                        <ul class="aa-testimonial-slider">
                            ...
                            <li>
                                <div class="aa-testimonial-single">
                                    <img class="aa-testimonial-img"
                                        src="{{ asset('front_assets/img/testimonial-img-2.jpg') }}"
                                        alt="testimonial img">
                            ...
                            <li>
                                <div class="aa-testimonial-single">
                                    <img class="aa-testimonial-img"
                                        src="{{ asset('front_assets/img/testimonial-img-1.jpg') }}"
                                        alt="testimonial img">
                                    <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt distinctio omnis
                                        possimus, facere, quidem qui!consectetur adipisicing elit. Sunt distinctio omnis
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="aa-latest-blog-single">
                                    <figure class="aa-blog-img">
                                        <a href="#"><img
                                                src="{{ asset('front_assets/img/promo-banner-1.jpg') }}"
                                                alt="img"></a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="aa-latest-blog-single">
                                    <figure class="aa-blog-img">
                                        <a href="#"><img
                                                src="{{ asset('front_assets/img/promo-banner-3.jpg') }}"
                                                alt="img"></a>
                                        <figcaption class="aa-blog-img-caption">
                                            <span href="#"><i class="fa fa-eye"></i>5K</span>
                                            <a href="#"><i class="fa fa-thumbs-o-up"></i>426</a>
                ...
                <div class="col-md-12">
                    <div class="aa-client-brand-area">
                        <ul class="aa-client-brand-slider">
                            <li><a href="#"><img src="{{ asset('front_assets/img/client-brand-java.png') }}"
                                        alt="java img"></a></li>
                            <li><a href="#"><img
                                        src="{{ asset('front_assets/img/client-brand-jquery.png') }}"
                                        alt="jquery img"></a>
                            </li>
                            <li><a href="#"><img
                                        src="{{ asset('front_assets/img/client-brand-html5.png') }}"
                                        alt="html5 img"></a></li>
                            <li><a href="#"><img src="{{ asset('front_assets/img/client-brand-css3.png') }}"
                                        alt="css3 img"></a></li>
                            <li><a href="#"><img
                                        src="{{ asset('front_assets/img/client-brand-wordpress.png') }}"
                                        alt="wordPress img"></a></li>
                            <li><a href="#"><img
                                        src="{{ asset('front_assets/img/client-brand-joomla.png') }}"
                                        alt="joomla img"></a>
                            </li>
                            <li><a href="#"><img src="{{ asset('front_assets/img/client-brand-java.png') }}"
                                        alt="java img"></a></li>
